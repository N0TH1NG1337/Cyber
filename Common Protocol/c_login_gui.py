...
class c_login_gui:
    ...
    def __init__(self,
                 parent_wnd,  # Parent window root
                 callback_register,  # register event callback function
                 callback_signin,  # login event callback function
                 callback_unload):  # unload event callback function
        self._username = ""
        self._password = ""
        ...
        self._register_callback = callback_register
        self._login_callback = callback_signin
        ...
        self._this_wnd.bind("<Destroy>", callback_unload)
